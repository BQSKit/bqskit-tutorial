...
class _UCCSDMixin:
    ...
    def generate_evolution_op(self, packed_amplitudes, num_time_slices=None, trotter_mode=None):
        """\
      ...
      # set default trotter steps and mode as needed
        if num_time_slices is None:
            num_time_slices = self._trotter_steps
        if trotter_mode is None:
            trotter_mode = self._trotter_mode
